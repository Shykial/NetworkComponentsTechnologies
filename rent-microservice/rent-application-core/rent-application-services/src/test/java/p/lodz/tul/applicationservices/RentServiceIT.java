...
class RentServiceIT {
    ...
    void createRent_TEST_OK() {
        ...
        Assertions.assertDoesNotThrow(() -> rentService.createRent(client1(), vehicle1()));
    ...
    void createRentWithStartDate_TEST_OK() {
        assertThat(rentService.getRentsForAccount(client1().getLogin()), is(empty()));
        Assertions.assertDoesNotThrow(() -> rentService.createRent(client1(), vehicle1(), parseDate("22/02/2021")));
        assertThat(rentService.getRentsForAccount(client1().getLogin()), hasSize(1));
    }
    ...
    void createRentWithStartEndDate_TEST_OK() {
        assertThat(rentService.getRentsForAccount(client1().getLogin()), is(empty()));
        Assertions.assertDoesNotThrow(() -> rentService.createRent(client1(), vehicle1(), parseDate("22/02/2021"), parseDate("25/02/2021")));
        assertThat(rentService.getRentsForAccount(client1().getLogin()), hasSize(1));
    }
    ...
    void endRent_TEST_OK() {
        ...
        Assertions.assertDoesNotThrow(() -> rentService.endRent(rent));
    ...
    void endRentWithEndDate_TEST_OK() {
        ...
        Assertions.assertDoesNotThrow(() -> rentService.endRent(rent, parseDate("31/03/2021")));
    ...
    void updateRent_TEST_OK() {
        ...
        Assertions.assertDoesNotThrow(() -> rentService.updateRent(rent));
