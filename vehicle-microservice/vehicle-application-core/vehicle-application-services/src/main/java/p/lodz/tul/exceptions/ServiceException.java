...
public class ServiceException extends Exception {
    ...
    public static final String RENT_NOT_FOUND = "Rent that you are looking for was not found in the p.lodz.tul.repository.";
    ...
    public static final String NOT_AUTHENTICATED = "Provided account was not found in the p.lodz.tul.repository.";
